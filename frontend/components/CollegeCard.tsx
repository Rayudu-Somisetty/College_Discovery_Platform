...
export default function CollegeCard({ college, onClick }: Props) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="surface h-full w-full p-5 text-left transition hover:-translate-y-0.5 hover:shadow-lg"
    >
